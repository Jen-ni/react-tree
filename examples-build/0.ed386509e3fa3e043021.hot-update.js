...
var tree_component_Tree = function (_React$PureComponent) {
  ...
  _createClass(Tree, [{
    ...
    value: function __renderTreeNode__REACT_HOT_LOADER__(node) {
      ...
      ) : react_default.a.createElement(es_TreeNode, { title: node.title, key: node.key, isLeaf: true });
    }
  }, {
...
tree_component_Tree.propTypes = {
  ...
  elements: prop_types["PropTypes"].arrayOf(prop_types["PropTypes"].shape({
    key: prop_types["PropTypes"].string,
    element: prop_types["PropTypes"].element
  })),
  prefixCls: prop_types["PropTypes"].string,
  children: prop_types["PropTypes"].any,
  // checkable: PropTypes.oneOfType([PropTypes.bool, PropTypes.node]),
  multiple: prop_types["PropTypes"].bool,
  // showLine: PropTypes.bool,
  // showIcon: PropTypes.bool,
  autoExpandParent: prop_types["PropTypes"].bool,
  //defaultExpandAll: PropTypes.bool,
  expandedKeys: prop_types["PropTypes"].arrayOf(prop_types["PropTypes"].string),
  // defaultExpandedKeys: PropTypes.arrayOf(PropTypes.string),
  checkedKeys: prop_types["PropTypes"].arrayOf(prop_types["PropTypes"].string),
  // defaultCheckedKeys: PropTypes.arrayOf(PropTypes.string),
  selectedKeys: prop_types["PropTypes"].arrayOf(prop_types["PropTypes"].string),
  // defaultSelectedKeys: PropTypes.arrayOf(PropTypes.string),
  // onExpand: PropTypes.func,
  onCheck: prop_types["PropTypes"].func,
  onSelect: prop_types["PropTypes"].func,
  loadData: prop_types["PropTypes"].func,
  onMouseEnter: prop_types["PropTypes"].func,
  onMouseLeave: prop_types["PropTypes"].func,
  onRightClick: prop_types["PropTypes"].func,
  onDragStart: prop_types["PropTypes"].func,
  onDragEnter: prop_types["PropTypes"].func,
  onDragOver: prop_types["PropTypes"].func,
  onDragLeave: prop_types["PropTypes"].func,
  onDrop: prop_types["PropTypes"].func,
  filterTreeNode: prop_types["PropTypes"].func,
  openTransitionName: prop_types["PropTypes"].string,
  openAnimation: prop_types["PropTypes"].oneOfType([prop_types["PropTypes"].string, prop_types["PropTypes"].object])
};
  ...
  forest_view_component__createClass(ForestView, [{
    ...
    value: function render() {
      ...
      return react_default.a.createElement(
        ...
        null,
        this.renderRcTree(),
        this.renderPine(data),
        this.renderSpruce(data)
      );
    }
  }]);
...
//# sourceMappingURL=0.ed386509e3fa3e043021.hot-update.js.map